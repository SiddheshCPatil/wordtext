    ...
    return (
        ...
        <div className='conatiner' style={myStyle}>
            ...
            {/* <div className="btn" my-2>
                ...
                <button onClick={enableDark} type="button" className="btn btn-primary mx-2">{btnText}</button> */}
            {/* <button type="button" className="btn btn-primary mx-2">Enable Light Mode </button> */}
            {/* </div> */}
        </div>
    )
}
